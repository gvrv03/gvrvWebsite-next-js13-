...
const ProductHeader = () => {
  return (
    <div className="fixed top-16  border-b-2  left-0 right-0 bg-white ">
      <div className="container p-5 m-auto flex justify-between items-center">
        <div className="text-xs md:text-sm ">Showing result for : <span className="ml-5  text-blue-500">All</span></div>
